  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const faculty = faculties.find(f => 
        f.name && f.name.toLowerCase().trim() === username.toLowerCase().trim()
      )
      ...
      toast.success(`Welcome ${faculty.name}! Redirecting to faculty portal...`, {
        position: "top-right",
        autoClose: 2000,
        hideProgressBar: false,
        closeOnClick: true,
    ...
    <>
      ...
      >
        ...
        >
          ...
          <input
            placeholder="Username (Admin: 'admin' | Faculty: Your Name)"
            value={username}
          ...
          <div style={{ position: 'relative' }}>
            <input
              ...
              placeholder="Password (Admin: password | Faculty: Login UUID)"
              value={password}
